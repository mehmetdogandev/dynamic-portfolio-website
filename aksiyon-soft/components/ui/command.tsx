  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          'placeholder:text-gray-400 dark:placeholder:text-gray-500 flex h-10 w-full rounded-md bg-transparent py-3 text-sm text-gray-900 dark:text-gray-100 outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        {...props}
      />
