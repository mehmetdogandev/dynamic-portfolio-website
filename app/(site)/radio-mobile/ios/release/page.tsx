...
const meta = getPublicPageMeta('ios_release')
...
export default async function RadioMobileIosReleasePage() {
  if (!(await isChannelPagePublic('ios_release'))) {
    notFound()
  }
  const builds = await listPublicBuilds('ios_release')
  return <RadioMobilePublicPage channel="ios_release" builds={builds} />
}
