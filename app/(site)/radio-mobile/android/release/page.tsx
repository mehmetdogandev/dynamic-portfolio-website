...
const meta = getPublicPageMeta('android_release')
...
export default async function RadioMobileAndroidReleasePage() {
  if (!(await isChannelPagePublic('android_release'))) {
    notFound()
  }
  const builds = await listPublicBuilds('android_release')
  return <RadioMobilePublicPage channel="android_release" builds={builds} />
}
